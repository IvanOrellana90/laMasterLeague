...
@section('main')
    ...
    @include('user.includes.modal-avatar')
                    ...
                    <div class="panel">
                        <div class="panel-body nav-tabs-animate nav-tabs-horizontal" data-plugin="tabs">
                            <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" data-toggle="tab" href="#info" aria-controls="info" role="tab">Información</a>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        ...
                                        <a class="dropdown-item" data-toggle="tab" href="#info" aria-controls="info"
                                           role="tab">Información <span class="badge badge-pill badge-danger">5</span></a>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane animation-slide-left" id="info" role="tabpanel">
